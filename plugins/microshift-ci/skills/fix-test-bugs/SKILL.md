...
- **doctor.py**: Deterministic pipeline script that orchestrates the CI analysis pipeline (runs `prow-job-analyzer` agents, bug correlation, and HTML report generation)
